            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="form-group mb-3">
                        ...
                        <img src="<?= base_url($produk->foto) ?>" width="100" class="mb-2">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="deskripsi" class="form-control" id="editor"><?= $produk->deskripsi ?></textarea>
                    </div>
                </div>
            </div>
